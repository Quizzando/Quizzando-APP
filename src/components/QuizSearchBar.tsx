...
export function QuizSearchBar() {
    ...
    const cursos = ["Engenharia de Software", "Medicina", "Direito", "Administração", "Psicologia", "Arquitetura"]
    ...
    const temposCreacao = ["Última semana", "Último mês", "Últimos 3 meses", "Último ano"]
    ...
    const handleSearch = () => {
        console.log("[v0] Searching with query:", searchQuery, "and filters:", filters)
        ...
        <div className="flex-1 max-w-2xl mx-4">
            <div className="relative">
                ...
                <Popover open={showFilters} onOpenChange={setShowFilters}>
                    ...
                    <Button variant="outline" size="sm" className="relative h-10 px-3 bg-transparent">
                    ...
                    <div className="space-y-4">
                        ...
                        <div>
                            ...
                            onValueChange={(value) => handleFilterChange("dificuldade", value)}
                            >
                            <SelectTrigger className="h-9">
                        ...
                        <div>
                            <label className="text-xs font-medium text-muted-foreground mb-1 block">Tempo de Criação</label>
                            <Select
                            value={filters.tempoCreacao}
                            onValueChange={(value) => handleFilterChange("tempoCreacao", value)}
                            >
                            <SelectTrigger className="h-9">
